...
public class Calculator {
    ...
    3. Decide its accessibility way (You want to call is with class name or with object name)
        static -> You want to call is with class name
        non-static -> You want to call is with object name
    ...
    5. Does it take any arguments
        ...
        NOTE: if your method is not void meaning it is return type you MUST
    ...
    //Create a method that finds the absolute int of 2 int numbers and returns it
